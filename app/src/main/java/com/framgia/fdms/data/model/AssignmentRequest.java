...
public class AssignmentRequest {
    ...
    public AssignmentRequest(int deviceId, int deviceCategoryId, int deviceCategoryGroupId,
    ...
    public static class Builder {
        ...
        public AssignmentRequest create() {
            return new AssignmentRequest(mNestedDeviceId,
