...
public class InventoryDeviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InventoryDeviceContract.Presenter mPresenter = new InventoryDevicePresenter(deviceReturnRepository);
        mViewModel.setPresenter(mPresenter);

        ActivityInventoryDeviceBinding mBinding = DataBindingUtil.setContentView(this, R.layout.activity_inventory_device);
