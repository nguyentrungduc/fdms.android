 ...
 * the UI as required.
 */
public class SelectMeetingRoomPresenter extends BaseSelectionPresenter {

    private MeetingRoomRepository mMeetingRoomRepository;


    public SelectMeetingRoomPresenter(BaseSelectionContract.ViewModel viewModel,
    ...
    private void getData(final String query, int page) {
        Disposable disposable = mMeetingRoomRepository
                .getListMeetingRoom(query, OUT_OF_INDEX, page, PER_PAGE)
