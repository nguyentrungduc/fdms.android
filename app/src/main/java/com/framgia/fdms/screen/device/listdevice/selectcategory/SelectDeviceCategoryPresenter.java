 ...
 * the UI as required.
 */
public class SelectDeviceCategoryPresenter extends BaseSelectionPresenter {

    private CategoryRepository mCategoryRepository;


    public SelectDeviceCategoryPresenter(BaseSelectionContract.ViewModel viewModel,
    ...
    private void getData(final String query, int page) {
        Disposable disposable = mCategoryRepository
                .getListCategory(query, OUT_OF_INDEX, page, PER_PAGE)
