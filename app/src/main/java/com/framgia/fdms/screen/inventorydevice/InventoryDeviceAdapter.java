...
public class InventoryDeviceAdapter extends RecyclerView.Adapter<InventoryDeviceAdapter.InventoryDeviceViewHolder> {
    ...
    public InventoryDeviceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ItemInventoryDeviceBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),
    ...
    public class InventoryDeviceViewHolder extends RecyclerView.ViewHolder {
        ...
        public void binding(Device device) {
            ...
            mBinding.setViewModel(new ItemDeviceInventoryViewModel(device));
