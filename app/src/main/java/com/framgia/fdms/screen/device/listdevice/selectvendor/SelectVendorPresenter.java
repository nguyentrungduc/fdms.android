 ...
 * the UI as required.
 */
public class SelectVendorPresenter extends BaseSelectionPresenter {

    private VendorRepository mVendorRepository;


    public SelectVendorPresenter(BaseSelectionContract.ViewModel viewModel,
    ...
    private void getData(final String query, int page) {
        Disposable disposable = mVendorRepository
                .getListVendor(query, page, PER_PAGE)
